...
import { FaculdadeDropDown } from '../components/FaculdadeDropDown';
...
const Curso = () => {
    ...
    const entityService = new CursoService();
        ...
        <div className="datatable-crud-demo">
            ...
            <Dialog visible={entityDialog} style={{ width: '450px' }} header={`Detalhes da ${entidadeNome}`} modal className="p-fluid" footer={entityDialogFooter} onHide={hideDialog}>
                ...
                <div className="p-field">
                    ...
                    <FaculdadeDropDown onChange={(value) => {console.log(value)}}/>
                    </div>
                </div>
                <div className="p-field">
